...
| [E2E-VGuard: Adversarial Prevention for Production LLM-based End-To-End Speech Synthesis](https://arxiv.org/abs/2511.07099) | NeurIPS 2025 | 2025 | - | - | - |

### Image Watermarking

| Title | Venue | Date | Code | Note | Supplement |
|:------|:-----:|:----:|:----:|:----:|:----------:|
| [Training Data Provenance Verification: Did Your Model Use Synthetic Data from My Generative Model for Training?](https://arxiv.org/abs/2503.09122) | CVPR 2025 | 2025-03 | [![Star](https://img.shields.io/github/stars/xieyc99/TrainProVe.svg?style=social&label=Star)](https://github.com/xieyc99/TrainProVe) | - | - |
...
| [EditGuard: Versatile Image Watermarking for Tamper Localization and Copyright Protection](https://arxiv.org/abs/2312.08883) | arXiv | 2023-12 | [![Star](https://img.shields.io/github/stars/xuanyuzhang21/EditGuard.svg?style=social&label=Star)](https://github.com/xuanyuzhang21/EditGuard) | - | - |
|  [PAI: Attack-Resistant Watermarking for AIGC Image Forensics via Diffusion-Based Semantic Deflection](https://arxiv.org/abs/2411.15561) | arXiv | 2024 | [![Star](https://img.shields.io/github/stars/QingyuLiu/PAI.svg?style=social&label=Star)](https://github.com/QingyuLiu/PAI) | [Note](paper/image/PAI/note.md) | - |
|  [Gaussian Shading: Provable Performance-Lossless Image Watermarking for Diffusion Models](https://github.com/zijin-yang/Gaussian-Shading) | CVPR 2024 | 2024 | [![Star](https://img.shields.io/github/stars/zijin-yang/Gaussian-Shading.svg?style=social&label=Star)](https://github.com/zijin-yang/Gaussian-Shading) | [Note](paper/image/GaussianShading_2024/note.md) | - |
|  [ZODiAC: Zero-shot Optimization-based Deep Image Anti-Copy](https://arxiv.org/abs/2311.15561) | NeurIPS 2023 | 2023 | - | [Note](paper/image/Zodiac_2023/note.md) | - |
...
| [User Inference Attacks on Large Language Models](https://arxiv.org/abs/2310.09266) | EMNLP 2024 | 2024-11 | - | - | - |
| [On the Effectiveness of Membership Inference in Targeted Data Extraction from Large Language Models](https://arxiv.org/abs/2512.13352) | SaTML 2026 | 2025-12 | - | - | - |
